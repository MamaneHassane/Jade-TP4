...
public class Acheteur3Container extends Application{
    protected Acheteur3 acheteur3;
    protected ObservableList<String> observableListData;
    @Override
    public void start(Stage stage) throws Exception {
        startContainer();
        stage.setTitle("Acheteur 3");
    ...
    private void startContainer() {
        ...
        try {
            AgentController agentController = container.createNewAgent("Acheteur 3", "tpjade.main.jadetp4.Acheteur3", new
                    Object[]{this});
